...
ALLOWED_HOSTS = config(
    'ALLOWED_HOSTS',
    default='localhost,127.0.0.1,mithunkumarrajak.pythonanywhere.com'
).split(',')
...
# Default file storage configurations (Django defaults are used for media and static files)
...
# sms configuration through twilio
import os
